...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="#" class="nav-item nav-item--placeholder" onclick="openReportsPlaceholder(event)">
...
<script>
function openReportsPlaceholder(e) {
    if (e) e.preventDefault();
    alert('Reports module coming soon.\n\nInstitution-wide analytics and exports will be available here.');
}
</script>
