        ...
        <div class="content-body">
            ...
            <div class="panel">
                <div class="panel-header">
                    ...
                    <a href="examinations.php" class="panel-view-all">View All</a>
                </div>
                <div class="exam-list">
                    <?php
                    // Replace with real DB query:
                    // $ongoing_exams = $pdo->query("SELECT * FROM examinations WHERE status = 'ongoing' ORDER BY created_at DESC")->fetchAll();
                    // if ($ongoing_exams): foreach ($ongoing_exams as $exam):
                    //
                    // For demo, a static placeholder is shown:
                    $demo_exams = [
                        ['name' => 'INFOSEC QUIZ #1', 'by' => 'JUANITO P. ALVAREZ JR.', 'timer' => '34:23', 'sub' => 'started less than a minute ago', 'done' => '0 / 35 Done'],
                        ['name' => 'INFOSEC QUIZ #2', 'by' => 'JUANITO P. ALVAREZ JR.', 'timer' => '34:23', 'sub' => 'started less than a minute ago', 'done' => '0 / 35 Done'],
                    ];
                    // Comment out the $demo_exams block and use the real query above in production.
