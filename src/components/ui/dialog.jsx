...
import { getPageScrollTop, restorePageScrollTop } from '@/lib/preservePageScroll.js'
...
function scheduleScrollRestore(scrollTop) {
  const restore = () => restorePageScrollTop(scrollTop)
      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          onOpenAutoFocus={(event) => {
            savedScrollY.current = getPageScrollTop()
            onOpenAutoFocus?.(event)
            scheduleScrollRestore(savedScrollY.current)
          }}
